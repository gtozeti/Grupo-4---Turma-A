...
public class JanelaMain extends javax.swing.JFrame {
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton17ActionPerformed
        ...
        if (jTable3.getSelectedRow() != -1) { // Condicionar para checar se foi selecionado um cliente ou nao
            ...
            aux = cdao.getAddress(
                    Integer.parseInt(jTable3.getModel().getValueAt(jTable3.getSelectedRow(), 0).toString())); // Recebendo dados do endereço a partir do "cod_cs" e comando SQL dentro do DaoCliente
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton16ActionPerformed
        JanelaAdicionarCliente j = new JanelaAdicionarCliente(this, true);
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton24ActionPerformed
        ...
        JComboBox cb = new JComboBox(DaoProduto.categoria().toArray()); // Chamando a função para buscar os valores distintos de categoria
        ...
        try {
            if (jTable5.getSelectedRow() != -1) {
                j.jLabel5.setText(jTable5.getValueAt(jTable5.getSelectedRow(), 0).toString());
                j.jTextField5.setText(jTable5.getValueAt(jTable5.getSelectedRow(), 2).toString());
                j.jFormattedTextField1.setText(jTable5.getValueAt(jTable5.getSelectedRow(), 3).toString().substring(3).replace(".", ","));
                j.jFormattedTextField2.setText(jTable5.getValueAt(jTable5.getSelectedRow(), 4).toString());
