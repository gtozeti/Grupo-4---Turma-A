 ...
 * @author Matheus
 */
public class GraphTest1 extends JFrame {

    public GraphTest1() {   // the constructor will contain the panel of a certain size and the close operations 
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new GraphTest1().setVisible(true);
            }
        });
    }
}
